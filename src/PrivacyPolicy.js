...
<p style={{ color: “#555”, fontSize: 13, marginTop: 8 }}>최종 업데이트: 2025년 4월</p>
  ...
  {[
    {
      title: "1. 수집하는 개인정보",
      content: "본 앱은 서비스 제공을 위해 아이디(사용자가 직접 설정), 이메일 주소(비밀번호 찾기 용도), 운동 기록(중량, 세션 히스토리)을 수집합니다."
    },
    {
      title: "2. 개인정보 수집 및 이용 목적",
      content: "수집한 개인정보는 회원 식별 및 로그인 서비스 제공, 비밀번호 분실 시 재설정, 개인별 운동 기록 저장 및 관리 목적으로만 사용됩니다."
    },
    {
